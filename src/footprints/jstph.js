module.exports = {
    ...
    body: p => {
        ...
        (module JST_PH_S2B-PH-K_02x2.00mm_Angled (layer F.Cu) (tedit 58D3FE32)
            ...
            (fp_line (start -4.25 0.25) (end -4.25 -1.35) (layer ${otherside}.SilkS) (width 0.15))
            (fp_line (start -4.25 -1.35) (end -4.95 -1.35) (layer ${otherside}.SilkS) (width 0.15))
            (fp_line (start -4.95 -1.35) (end -4.95 6.25) (layer ${otherside}.SilkS) (width 0.15))
            (fp_line (start -4.95 6.25) (end 0.95 6.25) (layer ${otherside}.SilkS) (width 0.15))
            (fp_line (start 0.95 6.25) (end 0.95 -1.35) (layer ${otherside}.SilkS) (width 0.15))
            (fp_line (start 0.95 -1.35) (end 0.25 -1.35) (layer ${otherside}.SilkS) (width 0.15))
            (fp_line (start 0.25 -1.35) (end 0.25 0.25) (layer ${otherside}.SilkS) (width 0.15))
            (fp_line (start 0.25 0.25) (end -4.25 0.25) (layer ${otherside}.SilkS) (width 0.15))
            ...
            (pad 0 thru_hole oval (at -3 0 ${p.rot}) (size 1.2 1.7) (drill 0.75) (layers *.Cu *.Mask) ${p.neg.str})
